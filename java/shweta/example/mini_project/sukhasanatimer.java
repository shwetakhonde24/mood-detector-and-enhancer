...
public class sukhasanatimer extends AppCompatActivity {
    SeekBar seekBar;
    TextView timer_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sukhasanatimer);
        SliderView sliderView = findViewById(R.id.imageslider);
        List<Integer> images = new ArrayList<>();
        images.add(R.drawable.sukhasanass);
    ...
    public void openDialog(){
        Sukasanainfo infoDialog = new Sukasanainfo();
